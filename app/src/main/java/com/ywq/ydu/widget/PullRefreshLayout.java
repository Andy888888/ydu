...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int colorsId = a.getResourceId(
                R.styleable.PullRefreshLayout_colors, R.array.google_colors);
        a.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth()
                - getPaddingRight() - getPaddingLeft(), View.MeasureSpec.EXACTLY);
        heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredHeight()
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                // float adjustedPercent = (float) Math.max(dragPercent - .4, 0) * 5
                // / 3;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mTarget.layout(left, top + mCurrentOffsetTop, left + width - right, top
                + height - bottom + mCurrentOffsetTop);
