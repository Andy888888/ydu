 ...
 * @author yanwenqiang
 * @Date 15-9-15
 * @description Fancy progress indicator for Material theme
 */
public class MaterialDrawable extends RefreshDrawable implements Animatable {
    ...
    public MaterialDrawable(Context context, PullRefreshLayout parent) {
        ...
        mDiameter = dp2px(40);
        mTop = -mDiameter - (getRefreshLayout().getFinalOffset() - mDiameter)
                / 2;
    }
    ...
    private void createCircleDrawable() {
        ...
        // circle.getPaint());
        mCircle.getPaint().setShadowLayer(mShadowRadius, shadowXOffset,
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        int w = right - left;
        super.setBounds(w / 2 - mDiameter / 2, top, w / 2 + mDiameter / 2,
                mDiameter + top);
    }
